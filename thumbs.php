...
/*
	...
	10. http://yoursite.com/path/to/thumbs.php?src=http://markmaunder.com/&webshot=1
...
class timthumb {
	...
	protected $salt = "";
	protected $fileCacheVersion = 1; //Generally if thumbs.php is modifed (upgraded) then the salt changes and all cache files are recreated. This is a backup mechanism to force regen.
